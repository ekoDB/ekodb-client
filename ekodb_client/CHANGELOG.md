...
#### Core Features
- **Convenience methods** across all client libraries (Rust, TypeScript, JavaScript, Python, Kotlin, Go):
  - `upsert()` - Insert or update with automatic fallback (atomic insert-or-update semantics)
...
#### Examples
- **New bypass_ripple examples** demonstrating ripple control in multi-node deployments (all languages)
- **New convenience methods examples** showcasing ergonomic API helpers (all languages)
...
### Fixed
- Kotlin client: JsonElement type handling for JsonObject, JsonArray, JsonPrimitive, and JsonNull
...
### Added
- **Functions and Scripts** - Complete implementation across all client libraries
...
### Fixed
- Version bumping script now correctly updates ekodb_client dependency in Python client
