...
[![Examples](https://img.shields.io/badge/Examples-inventory-blue)](examples_list.txt)
...
- **<!--ex:total-->314<!--/ex:total--> working examples** -
  <!--ex:client-->263<!--/ex:client--> client library +
