...
func run() (runErr error) {
	...
	fmt.Print("=== Query Builder Examples ===\n\n")
	...
	if err != nil {
		return fmt.Errorf("equality query: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("string query: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("in query: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("complex query: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("pagination query: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("not-in query: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("bypass-cache query: %w", err)
	}
